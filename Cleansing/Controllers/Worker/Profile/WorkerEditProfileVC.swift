...
import Photos
import Alamofire
class WorkerEditProfileVC: UIViewController {
...
extension WorkerEditProfileVC: UITextFieldDelegate
{
...
extension WorkerEditProfileVC: UIImagePickerControllerDelegate , UINavigationControllerDelegate
{
    //MARK: Menu Option
    func addOption()
    {
