//
//  WorkerClockInVC.swift
//  Cleansing
//
//  Created by uis on 08/01/24.
//
...
class WorkerClockInVC: UIViewController {
...
//    var breakID: Int = 0
    ...
    var breaksData:[(String, String)] = [("Start Break 1", "End Break 1")]
    var startTimes: Date?
...
//        alertController.addAction(cancelAction)
    ...
    @objc func floatingButtonTapped() {
            ...
            print("Floating button tapped!")
                if let VC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "WorkerDashVC") as? WorkerDashVC{
                    VC.hidesBottomBarWhenPushed = true
                         self.navigationController?.pushViewController(VC, animated: true)
                     }
        }
...
//}
//MARK: Location
extension WorkerClockInVC: CLLocationManagerDelegate {
...
extension WorkerClockInVC: UITextViewDelegate
{
...
extension WorkerClockInVC: UITableViewDelegate, UITableViewDataSource{
