...
extension ProfileVC {
    ...
    func firstCall()
    {
        ...
        getProfile()
        profileData.append(profile.init(image: ["profile2", "worker","email2","logout2"], name: ["Edit My Profile","My Workers","Contact Us","Log Out"]))
        appVersion.text = "Admin/Manager"
...
//            if let VC = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "MyWorkerVC") as? MyWorkerVC{
//                self.navigationController?.pushViewController(VC, animated: true)
//            }
